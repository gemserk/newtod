...
import com.gemserk.games.newtod.gamestates.PlayGameState;
...
public class Game extends com.gemserk.commons.gdx.Game {
	...
	public void create() {
		...
		Preferences preferences = Gdx.app.getPreferences("gemserk-newtod");
	...
	public void render() {
		...
		if (inputDevicesMonitor.getButton("grabScreenshot").isReleased()) {
			try {
				ScreenshotSaver.saveScreenshot("newtod");
			} catch (IOException e) {
				Gdx.app.log("newtod", "Can't save screenshot");
			}
		}
